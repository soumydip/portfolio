...
export default function Home() {
  return (
    ...
    >
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 sm:w-80 sm:h-80 md:w-100 md:h-100 lg:w-125 lg:h-125 bg-purple-500/10 blur-[80px] md:blur-[120px] rounded -z-10" />
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        >
          <div className="relative group cursor-pointer">
            <div className="absolute inset-0 bg-purple-500/20 blur-2xl md:blur-3xl rounded -z-10 animate-pulse group-hover:bg-purple-500/40 transition-all duration-500" />
            ...
            >
              <Image
                ...
                className="object-cover object-top  p-1.5 md:p-2 rounded md:rounded group-hover:scale-105 transition-transform duration-700"
                priority
              />
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 md:-bottom-10 md:-left-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md p-4 md:p-5 rounded md:rounded shadow-xl border border-slate-100 dark:border-slate-800 max-w-45 md:max-w-60 hidden sm:block"
            >
              <Quote
