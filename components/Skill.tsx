          ...
          >
            ...
            <div className="flex justify-center gap-4 mt-10 md:absolute md:top-1/2 md:w-full md:justify-between md:mt-0 md:-translate-y-1/2 md:px-2 pointer-events-none">
              <button
                ...
                className="pointer-events-auto p-3 rounded bg-white dark:bg-slate-800 shadow-lg border border-slate-200 dark:border-slate-700 hover:text-purple-600 transition-all active:scale-90"
              >
                <ChevronLeft size={24} />
              </button>
              <button
